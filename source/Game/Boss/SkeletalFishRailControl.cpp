...
void SkeletalFishRailControl::getMtx(TPos3f* pOut, f32 a2) {
    ...
    MR::calcGravityVector(normalRailInfo._0, railPos, &gravityVec, NULL, 0);
    negVector.negate(gravityVec);
    PSVECCrossProduct((const Vec*)negVector, (const Vec*)railDir, (Vec*)v15);
    PSVECCrossProduct((const Vec*)railDir, (const Vec*)v15, (Vec*)v14);
